  ...
  return (
    <View style={styles.container}>
      <View style={styles.navBar}>
        <TouchableOpacity onPress={() => setCurrentStep('plot')}><Text style={[styles.navText, currentStep === 'plot' && styles.activeNav]}>1. Plot</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  navText: { color: '#888', fontSize: 16, fontWeight: 'bold' },
